...
def main():
    ...
    model_names = [
        "ann_amazon_1k", "ann_amazon_25k", "ann_yelp",
        "lstm_amazon_1k", "lstm_amazon_25k", "lstm_yelp",
        "bert_amazon_1k", "bert_amazon_25k", "bert_yelp",
        "distilbert_amazon_1k", "distilbert_amazon_25k", "distilbert_yelp",
    ]
